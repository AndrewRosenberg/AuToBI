...
public class EnsembleSampledClassifier extends AuToBIClassifier {
  private List<AuToBIClassifier> classifiers;  // the ensemble of trained classifiers
  private AuToBIClassifier classifier;         // a placeholder for a single classifier
  ...
  public static List<FeatureSet> constructEnsembleFeatureSets(FeatureSet training_set) {
