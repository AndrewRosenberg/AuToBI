...
import edu.cuny.qc.speech.AuToBI.core.Aggregation;
...
/**
 * TimeValuePairFeatureExtractor extracts aggregations from a list of TimeValuePairs.
 */
public class TimeValuePairFeatureExtractor extends FeatureExtractor {
  ...
  /**
   * Constructs a new TimeValuePairFeatureExtractor with associated values and attribute name.
   * <p/>
  ...
  /**
   * Constructs a new empty TimeValuePairFeatureExtractor.
   */
  public TimeValuePairFeatureExtractor() {}
